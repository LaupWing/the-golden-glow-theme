...
return [
    ...
    // MULTIPLE text sections example!
    'text_sections' => [
        [
    ...
    'price' => [
        'title' => 'Wat is de prijs van een voorhoofdrimpels behandeling',
        'price' => '125',
    ...
    'why_section' => [
        'title' => 'Waarom een voorhoofd behandeling',
        'content' => '
            <p>Een voorhoofd behandeling met botox verzacht de horizontale rimpels en geeft uw gezicht een frisse, uitgeruste uitstraling.</p>
        ',
        'show_background' => false
    ],

    'faqs' => [
        'title' => 'Veelgestelde vragen over voorhoofdrimpel behandeling',
        'items' => [
            [
                'question' => 'Wat zijn voorhoofdrimpels?',
                'answer' => '<p>Voorhoofdrimpels zijn horizontale lijnen op het voorhoofd die ontstaan door herhaalde spierbewegingen.</p>'
            ],
            [
                'question' => 'Hoe lang duurt de behandeling?',
                'answer' => '<p>De behandeling duurt ongeveer 15 minuten.</p>'
            ]
        ]
    ]
];
