...
return [
    ...
    'content_blocks' => [
        [
            'type' => 'category-intro',
            'data' => [
                'title' => 'De rokerslijntjes van Teun',
                'content' => '
        ...
        [
            'type' => 'text-content',
            'data' => [
                'title' => 'De techniek achter het behandelen van rokerslijntjes',
                'content' => '
                    <p>Bij The Golden Glow in Amsterdam gebruiken wij voor het behandelen van rokerslijntjes hyaluronzuurfillers met een lichte consistentie, zoals Belotero Soft of Restylane Kysse, die fijn integreren in de delicate huid rondom de mond. Na een nauwkeurige analyse bepaalt de arts de beste plekken om volume subtiel te herstellen en lijntjes te verzachten. Voor een natuurlijk en zacht resultaat passen we de waaiertechniek toe, waarbij de filler in waaiervormige bewegingen met een fijne naald of canule wordt ingebracht. Dit zorgt voor een gelijkmatige verdeling van de filler en voorkomt een \'ingespoten\' uiterlijk. Soms combineren we dit met de blanching-techniek, die de huidstructuur verbetert en de fijne lijntjes extra verzacht. Door kleine doses filler nauwkeurig te plaatsen, ontstaat een natuurlijke verjonging van het gebied rondom de mond.</p>
                ',
        ...
        [
            'type' => 'text-content',
            'data' => [
                'title' => 'Wat u kunt verwachten na een behandeling van rokerslijntjes',
                'content' => '
        ...
        [
            ...
            'data' => [
                ...
                'items' => [
                    [
                        'question' => 'Wat zijn rokerslijntjes?',
                        'answer' => '<p>Rokerslijntjes zijn verticale rimpeltjes boven de bovenlip. Ze worden ook wel "barcode rimpels" genoemd en kunnen ontstaan door roken, veelvuldig tuiten van de lippen of natuurlijke huidveroudering.</p>'
                    ],
                    [
                        'question' => 'Hoe ontstaan rokerslijntjes?',
                        'answer' => '<p>De rimpeltjes worden veroorzaakt door herhaaldelijke beweging van de mondspieren en afname van collageen en elastine in de huid. Roken, zonblootstelling en leeftijd versnellen dit proces.</p>'
                    ],
                    [
                        'question' => 'Hoe helpt Botox tegen rokerslijntjes?',
                        'answer' => '<p>Met kleine hoeveelheden Botox worden de spiertjes rond de bovenlip ontspannen. Hierdoor worden de lijntjes minder zichtbaar en krijgt de huid een gladder en zachter uiterlijk.</p>'
                    ],
                    [
