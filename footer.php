<!-- Footer -->
<footer class="relative bg-background pt-12 overflow-hidden">
    <!-- Background Image -->
    <div class="relative py-10">
        ...
        <div class="container mx-auto px-[5%] relative z-10">
            ...
            <!-- Footer Main Content -->
            <div class="flex flex-col md:grid md:grid-cols-2 gap-8 lg:gap-12 mb-8">
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="tel:+310681390127"
                                class="flex items-center justify-center md:justify-start gap-3 text-sm text-gray-600 hover:text-primary transition-colors duration-200">
                        ...
                        <li>
                            <a href="https://www.google.com/maps/dir//Kerkstraat+147,+1017+GG+Amsterdam/@52.3636599,4.806017,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x47c6095ec8461b3f:0xf16509b967cc7cf4!2m2!1d4.8884172!2d52.3636886?entry=ttu&g_ep=EgoyMDI1MDMyNS4xIKXMDSoASAFQAw%3D%3D"
                                ...
                                class="flex items-start justify-center md:justify-start gap-3 text-sm text-gray-600 hover:text-primary transition-colors duration-200">
...
<style>
    ...
    html {
        ...
        /* Header height (80px) + extra offset (20px) */
    }
</style>
