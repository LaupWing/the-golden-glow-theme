<!-- Footer -->
<footer class="bg-background pt-12 pb-6">
    <div class="container mx-auto px-[5%]">

        <!-- Footer Main Content -->
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 mb-8">

            <!-- Column 1: Treatments & Certifications -->
            <div class="space-y-8">
            ...
            <!-- Column 3: You can add additional content here if needed -->
            <div class="hidden lg:block">
                <!-- Optional: Logo, Social Media, etc. -->
            </div>
